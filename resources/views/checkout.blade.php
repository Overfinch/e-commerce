                    ...
                    @foreach (Cart::content() as $cartItem)
                        ...
                        <div class="checkout-table-row">
                            <div class="checkout-table-row-left">
                                <img src="{{asset('img/products/'.$model->slug.'.png')}}" alt="item" class="checkout-table-img">
                                <div class="checkout-item-details">
                                    <div class="checkout-table-item">{{ $model->name }}</div>
                                    <div class="checkout-table-description">{{ $model->details }}</div>
                                    <div class="checkout-table-price">{{ $model->presentPrice() }}</div>
                                </div>
                            </div> <!-- end checkout-table -->

                            <div class="checkout-table-row-right">
                                <div class="checkout-table-quantity">{{ $cartItem->qty }}</div>
                            </div>
